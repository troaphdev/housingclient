...
public class HudEditorGUI extends GuiScreen {
    ...
    private void refreshElements() {
        ...
        addModuleElementIfEnabled(com.housingclient.module.modules.miscellaneous.AutoBegModule.class, "Auto Beg",
                hudDesigner.getAutoBegX(),
                hudDesigner.getAutoBegY(), 100, 15, "autobeg");
    ...
    private void updateModulePosition(HudElement element) {
        switch (element.id) {
            ...
            case "hiddenEntities":
                ...
                break;
            case "autobeg":
                hudDesigner.setAutoBegPosition(element.x, element.y);
                break;
        }
    }
